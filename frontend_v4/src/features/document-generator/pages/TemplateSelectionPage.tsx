...
import { TemplateGrid, TemplateFilters, RecentTemplates, TemplatePreviewModal } from "../components";
...
export default function TemplateSelectionPage() {
  ...
  // Navigate to form from preview modal
  const handleSelectFromPreview = (template: TemplateItem, provider?: string) => {
    const encodedFilename = encodeURIComponent(template.filename);
    if (provider) {
      navigate(`/generator/${encodedFilename}/${encodeURIComponent(provider)}`);
    } else {
